<template>
    <div class="city_container">
        ...
        <form class="city_form" @submit.prevent>
            ...
            v-model="inputValue" class="city_input input_style" required><!-- required必须，输入完之后表单才允许被提交-->
            </diV>
            <div>
        ...
        <div class="search_none_place" v-if="!placelist.length&&isSearch">很抱歉,无搜索结果</div>
    </div>
</template>
...
export default {
    ...
    async mounted() {
        this.cityid = this.$route.params.cityid//当前页面的路由
